...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Not Paid</td>
            <td>
                <a class="button" href="update.php?id=<?php echo $row['id_order'];?>">Edit</a>
                <a class="button" href="delete.php?id=<?php echo $row['id_order'];?>">Delete</a>
            </td>
        </tr>
        <?php }?>
    </tbody>
...
<a href="index.php" class="button">HOME</a> <a href="orderprint_form.php" class="button">ADD MORE PRINT</a>
<center><h2>Total Price: <?php echo rupiah($totalprice); $_SESSION['total_payment'] = $totalprice; ?></h2></center>
        <?php if($totalprice==0)
                  {?>

        <?php }else{?>
                <center><a href="payment_form.php" class="button">GO TO PAYMENT</a></center>
        <?php } ?>
